                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('handleLogin') }}">
                                ...
                                <div class="btn-box">
                                    <div class="d-flex align-items-center justify-content-between pb-4">
                                        <div class="custom-control custom-checkbox fs-15">
                                            ...
                                            <label class="custom-control-label custom--control-label"
                                                for="rememberMeCheckbox">Lưu thông tin</label>
                                        </div><!-- end custom-control -->
                                        <a href="recover.html" class="btn-text">Quên mật khẩu?</a>
                                    </div>
                                    ...
                                    <p class="fs-14 pt-2">Bạn chưa có tài khoản?
                                        <a href="{{ route('register') }}" class="text-color hover-underline">Đăng ký
                                            ngay</a>
                                    </p>
                                </div><!-- end btn-box -->
                            </form>
