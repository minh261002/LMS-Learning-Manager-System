    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 form-group mb-3">
                ...
                <div class="input-icon mb-2">
                    <input class="form-control " placeholder="Chọn ngày" id="datepicker-icon"
                        value="{{ $instructor->user->birthday }}" name="info[birthday]" autocomplete="off">
            ...
            <div class="col-12">
                ...
                <textarea name="info[description]" cols="3" class="form-control">{{ $instructor->user->description }}</textarea>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                ...
                <input type="text" class="form-control" id="info[address]" name="info[address]"
                    value="{{ old('address', $instructor->user->address ?? '') }}">
                @error('address')
